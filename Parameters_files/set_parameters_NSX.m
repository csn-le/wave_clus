function par=set_parameters_NSX(filename,handles)

% SPC PARAMETERS
par.mintemp = 0.00;                  % minimum temperature for SPC
par.maxtemp = 0.251;                 % maximum temperature for SPC %0.251???
...
par.fname = 'data_NSX';                  % filename for interaction with SPC
