classdef pl2ch_wc_reader < handle
	properties
          sr
          max_segments
          opened_file
	...
	methods 
        function obj = pl2ch_wc_reader(par, raw_filename)
            
            load('pl2_meta_data.mat','sr','lts','channels');
            obj.sr = sr;
			...
			fseek(obj.opened_file,initial_index*8,'bof');
        ...
        function x = get_segment(obj,i)
            x=fread(obj.opened_file,obj.segmentLength(i),'double=>double')';
